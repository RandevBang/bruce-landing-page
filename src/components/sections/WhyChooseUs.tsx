      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-[#131A46] mb-6">
              ...
              return (
                <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  <div className="bg-blue-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                    <IconComponent className="w-6 h-6 text-[#131A46]" />
                  </div>
                  <h3 className="text-xl font-semibold text-[#131A46] mb-3">
                    {feature.title}
                  </h3>
          ...
          {/* Process Steps */}
          <div className="mt-20">
            <h3 className="text-2xl lg:text-3xl font-bold text-[#131A46] text-center mb-12">
              Simple 3-Step Process
            </h3>
            
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-[#131A46] text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  1
                </div>
                <h4 className="text-lg font-semibold mb-2">Fill Out Form</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">Get Instant Quote</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold mb-2">Get Covered</h4>
