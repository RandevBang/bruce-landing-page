        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <h3 className="text-2xl font-bold text-[#131A46] mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-blue-100 p-3 rounded-lg flex-shrink-0">
                    <Clock className="w-6 h-6 text-[#131A46]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-blue-100 p-3 rounded-lg flex-shrink-0">
                    <Shield className="w-6 h-6 text-[#131A46]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-blue-100 p-3 rounded-lg flex-shrink-0">
                    <FileText className="w-6 h-6 text-[#131A46]" />
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h4 className="font-semibold text-lg mb-4 text-[#131A46]">Specialized Coverage For:</h4>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-[#131A46] rounded-full"></div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-6 lg:p-8 shadow-lg">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-[#131A46] mb-2">
                  Get Your Free Quote
                </h3>
